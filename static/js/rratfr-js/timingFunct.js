...
socket.on('entry_data', function (data) {
    ...
    $.each(data, function (i, value) {
        if (value.timing_status === "in_queue") {
            queueTable.row.add([value.bib_number, "<a class='text-success'><i class=\"fas fa-check-circle\"></i></a> " + value.entry_name, value.category]);
